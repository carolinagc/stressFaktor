...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { address: @description.address, description: @description.description, email: @description.email, link: @description.link, name: @description.name }
    end
  ...
  test "should update description" do
    put :update, id: @description, description: { address: @description.address, description: @description.description, email: @description.email, link: @description.link, name: @description.name }
    assert_redirected_to description_path(assigns(:description))
  end
